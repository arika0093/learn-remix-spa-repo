...
import { IconPackage, IconSearch, IconHome, IconUser, IconMoon, IconSun, IconBraces, IconTable } from "@tabler/icons-react"
        ...
        <div className="flex-1 min-w-0 w-full mx-4 md:mx-6">
          <form className="w-full">
            <div className="relative">
              ...
              <Input className="bg-white w-full pl-8" placeholder="特徴から探す" type="search" />
            </div>
          </form>
        </div>
        ...
        <div className="hidden pr-4 md:flex flex-col border-r bg-gray-100/40 dark:bg-gray-800/40">
          <div className="border-b">
            <nav className="flex flex-col gap-1">
              <Link className="flex w-full items-center gap-2 px-4 py-2 text-sm font-medium" to="/">
                <IconHome className="w-5" />
                トップページ
              </Link>
              <Link className="flex w-full items-center gap-2 px-4 py-2 text-sm font-medium" to="/from-list">
                <IconTable className="w-5" />
                一覧から探す
              </Link>
              <Link className="flex w-full items-center gap-2 px-4 py-2 text-sm font-medium" to="/from-images">
                <Image className="w-5" />
                画像から探す
              </Link>
              <Link className="flex w-full items-center gap-2 px-4 py-2 text-sm font-medium" to="/debug">
                <IconBraces className="w-5" />
                DEBUG
              </Link>
            </nav>
          </div>
          <div className="flex-1 border-b border-t"></div>
          <div className="flex grid place-items-center">
            <Link className="flex items-center gap-2 px-4 py-2 text-lg font-semibold" to="/">
              <IconPackage className="h-6 w-6" />
              <span>SPA!</span>
            </Link>
          </div>
